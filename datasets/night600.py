...
class Night600(BaseImageDataset):
    ...
    Night600
    Reference:
    Illumination Distillation Framework for Nighttime Person Re-Identification and a New Benchmark TMM 2023
    https://github.com/Alexadlu/IDF

    Dataset statistics:
    # identities: 600
    # images: 14462 (train) + 2180 (query) + 14351 (gallery)
    """
